...
public class Tabla {
    ...
    public void tablaUsuarios(ManagerUsuario managerUsuario) {
        ...
        System.out.println("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("%10s %14s %14s %14s %14s %14s %28s %14s %28s %14s", "ID", "NOMBRE", "APELLIDO", "USERNAME","TELEFONO","DNI","CORREO","DINERO","CUENTA","ADMIN");
        System.out.println();
        System.out.println("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
        for (int i = 0; i < managerUsuario.cantidadUsuarios(); i++) {
            System.out.format("%10s %14s %14s %14s %14s %14s %28s %14s %28s %14s",
                    managerUsuario.listaUsuarios().get(i).id, managerUsuario.listaUsuarios().get(i).nombre, managerUsuario.listaUsuarios().get(i).apellido, managerUsuario.listaUsuarios().get(i).usuario,
    ...
    public void tablaDonaciones(ManagerUsuario managerUsuario, ManagerONG managerONG) {
        ...
        System.out.println("---------------------------------------------------------------------------------------");
        System.out.printf("%10s %28s %14s %28s", "ID", "ONG", "CANTIDAD","FECHA");
        System.out.println();
        System.out.println("---------------------------------------------------------------------------------------");
        for (int i = 0; i < managerUsuario.donacionesUsuarioConectado().size(); i++) {
            System.out.format("%10s %28s %14s %28s",
                    i+1, managerONG.idToStringONG(managerUsuario.donacionesUsuarioConectado().get(i).ongID), managerUsuario.donacionesUsuarioConectado().get(i).dinero,managerUsuario.donacionesUsuarioConectado().get(i).fecha);
            System.out.println();
        }
    ...
    public void tablaSuscripciones(ManagerUsuario managerUsuario, ManagerONG managerONG) {
        ...
        System.out.println("------------------------------------------------------------");
        System.out.printf("%10s %28s %14s", "ID", "ONG", "CANTIDAD");
        System.out.println();
        System.out.println("------------------------------------------------------------");

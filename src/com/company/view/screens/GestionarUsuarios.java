...
public class GestionarUsuarios {
    ...
    public void start(ManagerUsuario managerUsuario, ManagerONG managerONG){
        ...
        menu.showMenuUsuario("Panel de control de usuarios", managerUsuario, managerONG, "Cambiar nombre", "Cambiar apellido", "Cambiar nombre usuario", "Cambiar contraseña", "Cambiar DNI","Cambiar correo","Cambiar teléfono","Borrar Usuario","Crear Usuario","Conceder permisos de Administrador","Volver al menú");
        ...
        switch (menu.option()) {
            ...
            case 10:
                try {
                    managerUsuario.concederPermisoAdministrador(managerUsuario.encontrarUsuario(new EditText("Indique el usuario al que quiere conceder permisos de administrador").pedirString()));

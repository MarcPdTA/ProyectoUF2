...
public class GestionarONGs {
    ...
    public void start(ManagerUsuario managerUsuario, ManagerONG managerONG, ManagerMensajes managerMensajes) {
        ...
        menu.showMenuUsuario("Panel de control de ONGs", managerUsuario, managerONG,managerMensajes,"Cambiar nombre", "Crear nueva ONG", "Eliminar ONG","Listar ONGs", "Volver al menú");
        switch (menu.option()) {
            case 1:
                ...
                new GestionarONGs().start(managerUsuario,managerONG,managerMensajes);
